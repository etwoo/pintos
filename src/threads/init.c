...
main(void)
{
	...
	filesys_init(format_filesys, 5 * 1000 /* 5s */);
#endif
#ifdef VM
	swap_init();
#endif
...
usage(void)
{
	printf("\nCommand line syntax: [OPTION...] [ACTION...]\n"
	       ...
	       "  extract            Untar from scratch device into file "
	       "system.\n"
	       "  append FILE        Append FILE to tar file on scratch "
	       "device.\n"
#endif
	       "\nOptions:\n"
...
#ifdef FILESYS
	       "  -f                 Format file system device during "
	       "startup.\n"
	       "  -filesys=BDEV      Use BDEV for file system instead of "
	       "default.\n"
	       ...
	       "  -mlfqs             Use multi-level feedback queue "
	       "scheduler.\n"
#ifdef USERPROG
