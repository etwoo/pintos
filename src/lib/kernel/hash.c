...
find_elem(struct hash *, struct list *, struct hash_elem *);
...
rehash(struct hash *h)
{
	...
	if (new_buckets == NULL) {
		/* Allocation failed.  This means that use of the hash table
		   will be less efficient.  However, it is still usable, so
