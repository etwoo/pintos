...
main(int argc __attribute__((unused)), char *argv[])
{
	...
	if (argc < 3) {
		fprintf(stderr,
		        ...
		        "Squishes both stdin and stdout into a single Unix "
		        "domain\n"
		        "socket named SOCKET, and runs COMMAND as a "
		        "subprocess.\n");
		return EXIT_FAILURE;
	}
